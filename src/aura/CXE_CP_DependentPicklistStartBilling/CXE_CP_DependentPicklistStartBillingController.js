({ 
   ...
   onControllerFieldChange: function(component, event, helper) {
       var eventTriggeronClickNextTab3 = component.get("v.eventTriggeronClickNextTab3");
       
       console.log('>>>>eventTriggeronClickNextTab3: '+eventTriggeronClickNextTab3);
   ...
   proceedChange: function(component, event, helper) {
      ...
      component.set("v.isNextClickedStart", false);
   },
    
    proceedChange2: function(component, event, helper) {
      helper.proceedChangeHelper2(component, event, helper);
      component.set("v.isNextClickedStart2", false);
   },
