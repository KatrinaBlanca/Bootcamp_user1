({
   ...
   handleEvent : function(component, event, helper, eventName){
      var selectEvent = $A.get("e.c:" + eventName);
      ...
      if(eventName == "CXE_selectBusinessProvinceEvent"){
         ...
         // selectDependentEvent.setParams({ "businessCity": event.getSource().get("v.value") }).fire();
         ...
         // selectDependentEvent.setParams({ "dependentPicklist": event.getSource().get("v.value") }).fire();
