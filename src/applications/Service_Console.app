...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>The out-of-the box utility console for users who work with multiple records on one screen.</description>
    ...
    <logo>SharedDocuments/Utility_Inc_logo_green_png.png</logo>
    <primaryTabColor>#16325c</primaryTabColor>
    <pushNotifications>
        <pushNotification>
